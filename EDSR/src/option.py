...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../experiment',
                    help='dataset directory')  # 数据集目录
parser.add_argument('--dir_demo', type=str, default='/home/cqy/桌面/CHAPTER 1 TEST/SLIDE FIRST/1',
                    help='demo image directory')  # 测试图片根目录
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='Demo',
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-800/1-651',
...
parser.add_argument('--pre_train', type=str, default=r'/home/cqy/下载/EDSR_WDSR_PyTorch-master/experiment/model',
                    help='pre-trained model directory')  # download则下载并加载，路径则加载路径
                                                         # 受resume参数影响

parser.add_argument('--extend', type=str, default=r'/home/cqy/下载/EDSR_WDSR_PyTorch-master/experiment/model',
